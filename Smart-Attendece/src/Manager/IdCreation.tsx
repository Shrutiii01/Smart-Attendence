...
import { LayoutDashboard, Users, CheckSquare, Clock, Bell, Settings, LogOut, UserPlus, ChevronRight, ExternalLink, Calendar } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';

interface CreateEmployeeIDProps {
    onNavigate?: (page: string) => void;
}

const CreateEmployeeID: React.FC<CreateEmployeeIDProps> = ({ onNavigate }) => {
    const [expandedMenu, setExpandedMenu] = useState<string | null>('employee');
